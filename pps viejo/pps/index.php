...
<section class="section-1">
            ...
            <div class="content-1 d-flex ">
                <!-- comente esto de la linea 42  display-colum align-center justify-content-center-->
                <h1 class="text-white fs-2 z-index">Tu lubricentro de confianza.</h1>
                <!--<span class="text-muted z-index" style="font-size: .8rem;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem quia harum consequuntur sequi temporibus odit itaque saepe doloremque magni dolore ut .</span> -->
            </div>
        </section>
        ...
        <div class="container">
            ...
            <h3 class="text-center mb-3">Con más de 20 años de experiencia en la industria, en Lubricentro Vintaje 76 somos expertos en ofrecer productos y servicios de alta calidad para el cuidado y mantenimiento de vehículos en Lomas de Zamora</h3>
                <div class="d-flex">
                <img src="public/imagen/dario.jpeg"  alt="">
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <span class="visually-hidden">Siguiente</span>
      ...
      <section class="section-2 py-3">
        <div class="container">
            <h2 class="fs-1 text-center  mb-1">Veni a nuestro lubricentro</h2>
        
            
            <h3 class="text-center mb-3">Contamos con los mejores precios de toda la zona, si no nos crees, veni y comprobalo por vos mismo!!</h3>
