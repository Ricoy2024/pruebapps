                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo RUTA_URL; ?>/AuthController/loginUsuario/"
                                    ...
                                    <div class="form-group">
                                        <input name="dni" type="text" class="form-control form-control-user input-margin"
                                            id="exampleInputDni" pattern="\d*" inputmode="numeric" aria-describedby="dniHelp" placeholder="DNI" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-center espacioboton">
                                    <a class="medium blue-text" href="<?php echo RUTA_URL;?>/AuthController/loginAdministrador">Entrar como administrador</a>
                                    </div>
